...
def send_mail_test():
    ...
    with smtplib.SMTP_SSL("smtp.gmail.com", port, context=context) as server:
        ...
        server.sendmail('user.user09112000@gmail.com', 'user.user09112000@gmail.com',
                        "Warning fire accident has been reported")  # recipients mail with mail m
def send_mail_function(): # defined function to send mail post fire detection using threading
    
    recipientmail = 'user.user09112000@gmail.com' # recipients mail
    ...
    try:
        ...
        server.starttls()
        server.ehlo()
        server.login('user.user09112000@gmail.com', 'opdwqjciifewcolb') # Senders mail ID and password
        server.sendmail('user.user09112000@gmail.com', recipientmail, "Warning fire accident has been reported") # recipients mail with mail message
...
while(True):
    ...
    for (x,y,w,h) in fire:
        ...
        threading.Thread(target=play_alarm_sound_function).start()  # To call alarm thread thread
